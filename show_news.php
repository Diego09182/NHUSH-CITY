  ...
  <body>
    ...
    <?php	
      ...
      while ($row = mysqli_fetch_assoc($result))
      {
		...
		echo"<div class='col s4 m3'>";
			echo"<div class='card left'>";
				echo"<div class='card-image'>";
					echo"<img src='images/head.jpg'>";
					echo"<br>";
				echo"</div>";
			...
			echo"<ul class='collapsible' data-collapsible='accordion'>";
				echo"<li>";
					...
					echo"<div class='collapsible-body'><p>".$row["info"]."</p></div>";
				echo"</li>";
			echo"</ul>";
		echo"</div>";
		
		echo"<div class='col s8 m9 right'>";
			echo"<div class='card' id='app' >";
				echo"<br>";
				echo"<br>";
						echo"<div class='card-content'>";
							...
							echo"<div class='card-action'>";
								...
								echo"<a class='btn-floating halfway-fab waves-effect waves-light brown right' herf='dislike.php'><i class='tooltipped' data-delay='50' data-tooltip='噓他'><i class='material-icons'>thumb_down</i></i></a>";
								echo"<a class='btn-floating halfway-fab waves-effect waves-light brown right' herf='like.php'><i class='tooltipped' data-delay='50' data-tooltip='點讚'><i class='material-icons'>thumb_up</i></i></a>";
		...
		echo"<div id='modal2' class='modal'>";
		  	...
		  	echo"<div class='row'>";
		  		echo"<div class='col s3 m3'>";
		  			echo"<div class='card'>";
		  					...
		  					echo"<br>";
		  					echo"<div class='card-content'>";
		  						echo"<h5>使用者:".$row["author"]."</h5>";
		  						echo"<p>自我簡介:".$row["info"]."</p>";
		  						echo"<br>";
		  					echo"</div>";
		  			echo"</div>";
		  		echo"</div>";
		  ...
		  echo"<div class='modal-footer'>";
		  	echo"<a href='#!' class='modal-action modal-close waves-effect waves-green btn-flat'>關閉</a>";
		  	echo"</div>";
		  echo"</div>";
		echo"</div>";
					...
					<span class="card-title">此貼文違反的規定</span>
						<form name="report" method="post" action="report.php">
							...
							<div class="row">
								...
								<div class="input-field col s12 m12">
									<i class="material-icons prefix">mode_edit</i>
									<textarea name="report_content" id="textarea" class="materialize-textarea" length="80"></textarea>
									<label for="last_name">檢舉附註內容</label>
								</div>
							</div>
							<br>
							<div class="card-action center-align">
								<a class="waves-effect waves-light btn" onClick="check_report()">發送</a>
								<a class="waves-effect waves-light btn" onClick="reset_report()">重新輸入</a>
							</div>
						</form>
					</div>
				</div>
