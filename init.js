				...
				<div class="modal-content">
					<form action="addmember.php" method="post" name="myForm">
					  <h4 class="center-align">註冊帳號</h4>
						...
						<div class="input-field col s12 m6">
							<i class="material-icons prefix">https</i>
							<input name="student_ID" id="student_ID" type="text" class="validate" size="15">
							<label for="icon_telephone">學號</label>
						</div>
						<div class="input-field col s4">
							<input name="year" id="year" type="text" class="validate" size="2">
							<label for="icon_prefix">年(民國)</label>
						</div>
						<div class="input-field col s4">
							<input name="month" id="month" type="text" class="validate" size="2">
							<label for="icon_prefix">月</label>
						</div>
						<div class="input-field col s4">
							<input name="day" id="day" type="text" class="validate" size="2">
							<label for="icon_prefix">日</label>
						</div>
						<div class="input-field col s12 m6">
							<i class="material-icons prefix">account_circle</i>
							<input name="account" id="account" type="text" class="validate" size="15">
							<label for="icon_prefix">註冊帳號</label>
						</div>
						<br> 
						<div class="input-field col s12 m6">
						...
						<div class="input-field col s12">
							<i class="material-icons prefix">account_circle</i>
							<input name="interest" id="interest" type="text" size="50" class="validate">
							<label for="telephone" data-error="wrong" data-success="right">個人興趣</label>
						</div>
						<div class="input-field col s12">
							<i class="material-icons prefix">account_circle</i>
							<input name="url" id="url" type="text" size="50" class="validate">
							<label for="telephone" data-error="wrong" data-success="right">個人網站</label>
						</div>
						<div class="input-field col s12">
							<i class="material-icons prefix">account_circle</i>
